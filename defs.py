...
def aleatorio():
    ...
    if perg_aleatoria == 1: Perguntas("somp1","imgp1","BASE","ALICERCE","FUNDAMENTO","RUINA")
    if perg_aleatoria == 2: Perguntas("somp2","imgp2","UM TREM","UMA CARAVELA","UMA BICICLETA","UMA MOTO")
    if perg_aleatoria == 3: Perguntas("somp3","imgp3","ITALIA","ALEMANHA","RÚSSIA","ESPANHA")
    if perg_aleatoria == 4: Perguntas("somp4","imgp4","QUEIJO","PEDRA","FRUTA","AGUA")
    if perg_aleatoria == 5: Perguntas("somp5","imgp5","FOGO","MAR","CÉU","CAMPO")
    if perg_aleatoria == 6: Perguntas("somp6","imgp6","JEJUNO","ÚTERO","BAÇO","DELGADO")
    if perg_aleatoria == 7: Perguntas("somp7","imgp7","NO MAR","NO PARAISO","NA TERRA","NO INFERNO")
